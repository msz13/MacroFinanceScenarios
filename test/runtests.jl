...
include(joinpath(@__DIR__, "models", "tcvar_sv", "tcvar_sv_priors_test.jl"))
include(joinpath(@__DIR__, "models", "tcvar_sv", "tcvar_sv_model_test.jl"))
include(joinpath(@__DIR__, "models", "tcvar_sv", "tcvar_sv_result_test.jl"))
